...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `tank_booking` WHERE `booking_id` = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        <body>
            ...
            <form action="update_process_tankorder.php" method="post">
            ...
            <label for="user_email">Email:</label>
                ...
                <input type="number" name="number_of_tanks" value="<?php echo $row['number_of_tanks']; ?>"><br>
