...
$numberOfPools = isset($_SESSION['booking']['number_of_pools']) ? $_SESSION['booking']['number_of_pools'] : 'Not specified';
...
<h3>Thank you for choosing Cleanise!<br> An email for the confirmation of the order will be sent shortly</h3>
    ...
    <h4><strong>Number of Pools:</strong> <?php echo $numberOfPools; ?></h4>
