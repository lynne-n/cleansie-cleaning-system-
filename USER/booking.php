...
$sqlServices = "SELECT service_name, chemical, price FROM pool";
...
<body>
    ...
    <form action="process_booking.php" method="post">
        ...
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<select name="selected_service" required>
            <?php echo $serviceOptions; ?>
        </select><br>
        <br>
        <label for="allergy_preference">Chemical Allergy:</label>
        &nbsp<input type="text" name="allergy_preference" required>
        <br><br>
        <label for="cleaning_date">Cleaning Date:</label>
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="date" name="cleaning_date" required min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>">
        <br><br>
        <label for="number_of_pools">Number of Pools:</label>
        &nbsp&nbsp<input type="number" name="number_of_pools" required min="1" max="10">
        <br><br>
