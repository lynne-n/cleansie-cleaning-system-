...
$allergyPreference = isset($_SESSION['booking']['allergy_preference']) ? $_SESSION['booking']['allergy_preference'] : 'Not specified';
$cleaningDate = isset($_SESSION['booking']['cleaning_date']) ? $_SESSION['booking']['cleaning_date'] : 'Not specified';
$numberOfTanks = isset($_SESSION['booking']['number_of_tanks']) ? $_SESSION['booking']['number_of_tanks'] : 'Not specified';
...
<h3>Thank you for choosing Cleanise!<br> An email for the confirmation of the order will be sent shortly</h3>
    ...
    <h4><strong>Chemical Preference:</strong> <?php echo $allergyPreference; ?></h4>
    <h4><strong>Cleaning Date:</strong> <?php echo $cleaningDate; ?></h4>
    <h4><strong>Number of Tanks:</strong> <?php echo $numberOfTanks; ?></h4>
